...
public class ReplayRecorder : MonoBehaviour
{
    ...
    void ApplyFrame(ReplayFrame frame)
    {
        ...
        if (gm.activePowerup != PowerupType.None &&
            replayPowerup == PowerupType.None)
            mar.UsePowerup();
    ...
    {
        if (powerup == string.Empty) return PowerupType.None;
        switch (powerup)
        {
            case "None": return PowerupType.None;
            case "SuperSpeed": return PowerupType.SuperSpeed;
            case "SuperJump": return PowerupType.SuperJump;
            case "SuperBounce": return PowerupType.SuperBounce;
            case "ShockAbsorber": return PowerupType.ShockAbsorber;
            case "TimeTravel": return PowerupType.TimeTravel;
            case "AntiGravity": return PowerupType.AntiGravity;
            case "Gyrocopter": return PowerupType.Gyrocopter;
            case "EasterEgg": return PowerupType.EasterEgg;
        }
    ...
    static string ConvertPowerupString(PowerupType powerup)
    {
        switch (powerup)
        {
            ...
            case PowerupType.SuperSpeed: return "SuperSpeed";
            case PowerupType.SuperBounce: return "SuperBounce";
            case PowerupType.ShockAbsorber: return "ShockAbsorber";
            case PowerupType.TimeTravel: return "TimeTravel";
            case PowerupType.AntiGravity: return "AntiGravity";
            case PowerupType.Gyrocopter: return "Gyrocopter";
            case PowerupType.EasterEgg: return "EasterEgg";
        }
        return string.Empty;
    }
}
