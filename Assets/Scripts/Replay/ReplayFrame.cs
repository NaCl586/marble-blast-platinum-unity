...
{
    //Positions
    public float pX, pY, pZ; //marble pos
    public float rX, rY, rZ, rW; //marble rotation
    public float sX, sY, sZ; //marble localScale
    public float cX, cY, cZ; //camera offset
    public float vX, vY, vZ; //marble velocity
    public float wX, wY, wZ; //marble angular velocity

    //bounce
    public int bounce;
    public float bounceStrength;
    public float bX, bY, bZ; // collision point
    public float nX, nY, nZ; // collision normal
    ...
    //Gravity modifier
    public float gX, gY, gZ; //gravity direction
    ...
    {
        pX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        pY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        pZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        rX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        rY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        rZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        rW = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        sX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        sY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        sZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        cX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        cY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        cZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        vX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        vY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        vZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        wX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        wY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        wZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        ...
        activePowerup = System.Text.Encoding.ASCII.GetString(byteArray, stringStart, playhead - stringStart); playhead++;

        time = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        contactPct = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        slipAmount = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        jump = System.BitConverter.ToInt32(byteArray, playhead); playhead += 4;
        gemCount = System.BitConverter.ToInt32(byteArray, playhead); playhead += 4;
        respawn = System.BitConverter.ToInt32(byteArray, playhead); playhead += 4;

        gX = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        gY = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;
        gZ = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        gravityStrength = System.BitConverter.ToSingle(byteArray, playhead); playhead += 4;

        gameFinished = System.BitConverter.ToInt32(byteArray, playhead); playhead += 4;
        teleportFinished = System.BitConverter.ToInt32(byteArray, playhead); playhead += 4;
