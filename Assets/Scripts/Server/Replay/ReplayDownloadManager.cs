...
namespace Server.Replay
{
    public class ReplayDownloadManager
    {
        ...
        public ReplayDownloadManager(
            ReplayApi replayApi)
        {
            _replayApi = replayApi;
        }

        public async UniTask<string> DownloadReplayAsync(
            int scoreId,
            string finalPath)
        {
            string directory =
            ...
            string downloadedPath =
                await _replayApi.DownloadReplayAsync(
                    scoreId,
                    directory);
            ...
            {
                throw new Exception(
                    "Replay download returned an empty path.");
            }
