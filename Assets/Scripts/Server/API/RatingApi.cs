...
namespace Server.API
{
    ...
    SyncAchievementsAsync(
        ...
        public UniTask<GlobalRatingLeaderboardResponse>
    GetGlobalLeaderboardAsync(
        int page,
        int pageSize)
        {
            return _client.GetAsync<
                GlobalRatingLeaderboardResponse>(
                $"/api/ratings/global" +
                $"?page={page}" +
                $"&pageSize={pageSize}");
        }

        public UniTask<GameRatingLeaderboardResponse>
        ...
        public UniTask<GlobalRatingResponse>
    GetMyRatingAsync()
        {
            return _client.GetAsync<
