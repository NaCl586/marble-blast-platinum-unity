...
public class ReplayMenuManager : MonoBehaviour
{
    ...
    [Space]
    [SerializeField] private Scrollbar replayScrollbar;
    public ScrollRect replayScrollRect;
    [SerializeField] private Button replayScrollUpButton;
    [SerializeField] private Button replayScrollDownButton;
    [SerializeField] private Scrollbar descScrollbar;
    public ScrollRect descScrollRect;
    [SerializeField] private Button descScrollUpButton;
    [SerializeField] private Button descScrollDownButton;
    ...
    void LoadReplay()
    {
        ...
        MissionInfo.instance.goldTime = selectedMission.goldTime;
    ...
    private void PopulateReplayButtons()
    {
        foreach (Replay replay in replays)
        {
            ...
            string replayName = string.IsNullOrWhiteSpace(replay.replayName) ? replay.fileName : replay.replayName;
            ...
            button.onClick.AddListener(() =>
            {
                ...
                button.GetComponentInChildren<TextMeshProUGUI>().color = new Color(0.9804f, 0.7843f, 0.5137f, 1f);
    ...
    private void SelectReplay(Replay replay)
    {
        ...
        authorText.text =
            string.IsNullOrWhiteSpace(replay.author)
                ? "Not Specified"
                : replay.author;

        descriptionText.text =
            string.IsNullOrWhiteSpace(replay.description)
                ? "No Description."
                : replay.description;
    ...
    private Mission FindMission(string missionPath)
    {
        ...
        {
            Mission mission = list.Find(m =>
                m.directory == missionPath);
