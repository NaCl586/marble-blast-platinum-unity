...
public class LeaderboardsAuth : MonoBehaviour
{
    ...
    public async void OnRegisterClicked()
    {
        ...
        try
        {
            await OnlineManager.Instance.Auth.RegisterAsync(
                username,
                password);

            loadingMessage.text =
                "Account Created, Returning to Login Menu...";
    ...
    private void LoadRememberedCredentials()
    {
        ...
        Credential credential =
            OnlineManager.Instance.Auth.LoadRememberedCredential();
    ...
    private string GetErrorMessage(Exception ex)
    {
        ...
        try
        {
            ...
            if (messageToken != null &&
                !string.IsNullOrWhiteSpace(messageToken.ToString()))
            {
