...
public class LeaderboardsPlayMission : PlayMissionManager
{
    ...
    protected override void Start()
    {
        ...
        if (watchReplay != null)
        {
            watchReplay.onClick.AddListener(
                OnWatchReplayClicked);
        }
    ...
    protected override List<Mission> GetMissionsList(Type difficulty, Game game)
    {
        ...
        return base.GetMissionsList(difficulty, game);
    }
    ...
    protected override void UpdateMissionSpecificUI(
    int levelIndex)
    {
        ...
        UpdateGlobalRecordsFromDatabase(
            leaderboardRequestId);
    }
        ...
        try
        {
            if (OnlineManager.Instance == null)
            {
                Debug.LogWarning(
                    ...
                    "OnlineManager instance not found.");
            ...
            {
                Debug.Log(
                    "Ignoring outdated leaderboard response.");
            ...
            Debug.Log(
                $"Loaded leaderboard for {level}. " +
                $"Entries: {response.Scores.Count}");
        ...
        Action<Exception> onFailure)
    {
        try
        {
            ...
            string path =
                await OnlineManager.Instance.ReplayDownload
                    .DownloadReplayAsync(
                        scoreId,
                        savePath);
